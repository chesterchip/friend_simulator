...
const EmotionAnalyzer = (function() {
     ...
     */
    function analyzeText(text, isButtonClick = false) {
        text = text.trim();
    ...
    function calculateEmotionScores(text) {
        ...
        for (const emotion in Config.emotions) {
            scores[emotion] = 0.1;
        }
        
        // Simple keyword matching
        const lowerText = text.toLowerCase();
        for (const emotion in Config.keywords) {
            for (const keyword of Config.keywords[emotion]) {
